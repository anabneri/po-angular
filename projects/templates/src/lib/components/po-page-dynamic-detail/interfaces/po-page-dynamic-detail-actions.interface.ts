...
export interface PoPageDynamicDetailActions {
   ...
   * - **back**: string com a nova rota para navegação. Esta rota substituirá a função ou rota definida anteriormente na ação *back*,
   * - **stopBack**: boolean que define se deve ou não executar a ação de voltar (*back*)
   *
